    ...
    var e = {
            ...
            widgetSection: function(i) {
                function a(t) {
                    ...
                    function a() {
                        if (!i.hasClass("wpr-sticky-section-yes") && !i.find(".wpr-sticky-section-yes-editor")) return void(_ = "relative");
                        var e = [],
                            a = [
                                ["mobile_sticky", 768],
                        ...
                        a.forEach((t, a) => {
                            if (t[1] > l) {
                                var r = t[0].replace("_sticky", "");
                                w = "desktop" == r ? i.data("settings") ? v + i.data("settings").wpr_sticky_effects_offset : v + i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-offset-settings") : i.data("settings") ? v + i.data("settings")["wpr_sticky_effects_offset_" + r] : v + i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-offset-settings"), -1 === p.indexOf(t[0]) ? (_ = -1 === c ? .indexOf(t[0]) ? e[a - 1] ? e[a - 1] : n : "relative", e[a] = _) : -1 !== p.indexOf(t[0]) && (_ = n)
                            }
                        });
                        var s = function() {
                            let e = m.scrollTop();
                            "fixed" != _ && (e > v ? r() : e <= v && i.css({
                                position: "relative"
                            })), "relative" !== _ && (e > w ? "yes" == i.data("wpr-replace-header") ? "yes" === i.data("wpr-sticky-hide") ? (e >= v && i.addClass("wpr-visibility-hidden"), e < h && i.next().addClass("wpr-hidden-header").addClass("wpr-" + u + "-in")) : (i.addClass("wpr-visibility-hidden"), i.next().addClass("wpr-hidden-header").addClass("wpr-" + u + "-in")) : i.addClass("wpr-sticky-header") : e <= w && ("yes" == i.data("wpr-replace-header") ? (i.next().removeClass("wpr-hidden-header"), i.removeClass("wpr-visibility-hidden"), i.next().removeClass("wpr-" + u + "-in")) : i.removeClass("wpr-sticky-header"))), "yes" === i.data("wpr-sticky-hide") && e >= v && (e < h ? "yes" === i.data("wpr-replace-header") ? (i.next().removeClass("wpr-" + u + "-out"), i.next().addClass("wpr-" + u + "-in")) : (i.removeClass("wpr-" + u + "-out"), i.addClass("wpr-" + u + "-in")) : "yes" === i.data("wpr-replace-header") ? (i.next().removeClass("wpr-" + u + "-in"), i.next().addClass("wpr-" + u + "-out")) : (i.removeClass("wpr-" + u + "-in"), i.addClass("wpr-" + u + "-out"))), clearTimeout(o), o = setTimeout(() => {
                                h = e
                            }, 10)
                        };
                        "sticky" == _ ? t(window).scroll(s) : "fixed" == _ && (r(), t(window).scroll(s)), "yes" == i.data("wpr-replace-header") && i.next().get(0).style.setProperty("--wpr-animation-duration", C);
                        let o
                    }
                    ...
                    function s() {
                        t("#wpadminbar").length && (x = t("#wpadminbar").css("height").slice(0, t("#wpadminbar").css("height").length - 2), "top" === o && "fixed" == i.css("position") && (i.css("top", +x + k + "px"), i.css("bottom", "auto")))
                    }
                    var n = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-position-type") : i.attr("data-wpr-position-type"),
                        ...
                        v = i.offset().top,
                        _, x;
                    u = i.data("settings").sticky_animation ? i.data("settings").sticky_animation : i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-animation");
                    var C = i.attr("data-wpr-animation-duration") ? i.attr("data-wpr-animation-duration") + "s" : "500s";
                    if (0 < i.closest("div[data-elementor-type=\"wp-post\"]").length ? g = i.closest("div[data-elementor-type=\"wp-post\"]") : 0 < i.closest("div[data-elementor-type=\"header\"]").length ? g = i.closest("div[data-elementor-type=\"header\"]") : 0 < i.closest("div[data-elementor-type=\"footer\"]").length && (g = i.closest("div[data-elementor-type=\"footer\"]")), i.find(".wpr-sticky-section-yes-editor").length || (n = i.attr("data-wpr-position-type"), o = i.attr("data-wpr-position-location"), d = i.attr("data-wpr-position-offset"), p = i.attr("data-wpr-sticky-devices"), c = i.attr("data-wpr-active-breakpoints"), y = i.attr("data-wpr-z-index")), "top" === o && "auto" === i.css("top")) {
                        var k = 0;
                        i.css("top", 0)
                    } else var k = +i.css("top").slice(0, -2);
                    if (0 == p.length && (n = "relative"), e.editorCheck() && p) {
                        var T = i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-devices");
                        i.attr("data-wpr-sticky-devices", T), p = i.attr("data-wpr-sticky-devices")
                    }
                    a(), s(), t(window).smartresize(function() {
                        v = i.offset().top, l = t("body").prop("clientWidth") + 17, t(window).scrollTop() <= w && a()
                    }), f || (_ = "relative")
                }()
            },
            widgetNavMenu: function(i) {
                function a() {
                    if (i.hasClass("wpr-mobile-menu-full-width") && i.closest(".elementor-column").length) {
                        var e = i.closest(".elementor-column"),
                            t = i.closest(".elementor-top-section").outerWidth() - 2 * l.offset().left,
                            a = e.offset().left + parseInt(e.css("padding-left"), 10);
                        l.css({
                            width: t + "px",
                            left: -a + "px"
                        })
            ...
            widgetMegaMenu: function(i) {
                ...
                function r() {
                    if (i.hasClass("wpr-mobile-menu-full-width") && i.closest(".elementor-column").length) {
                        var e = i.closest(".elementor-column"),
                            t = i.closest(".elementor-top-section").outerWidth() - 2 * c.offset().left,
                            a = e.offset().left + parseInt(e.css("padding-left"), 10);
                        c.parent("div").css({
                            width: t + "px",
                            left: -a + "px"
            ...
            widgetOnepageNav: function(e) {
                t(document).ready(function() {
                    ...
                    i.each(function() {
                        ...
                        e.preventDefaut(), e.stopPropagation();
                ...
                function n(i) {
                    if (-1 !== a.find(".wpr-grid-item-lightbox").length) {
                        ...
                        r.each(function() {
                            ...
                            e.editorCheck() ? alert("Lightbox is Disabled in the Editor!") : t(this).closest("article").find(".wpr-grid-image-wrap").trigger("click")
                        })) : r.find(".inner-block > span").on("click", function() {
                            if (!e.editorCheck()) {
                                var i = t(this).closest("article").find(".wpr-grid-image-wrap");
                                i.trigger("click")
                            } else alert("Lightbox is Disabled in the Editor!")
                        })
                    }
                }
                ...
                if (h.length) {
                    ...
                    if ("undefined" != typeof y && !1 !== y) {
                        ...
                        if (h.on("arrangeComplete", function(e, i) {
                            ...
                            }), ("load-more" === y.pagination_type || "infinite-scroll" === y.pagination_type) && a.find(".wpr-grid-pagination").length && !e.editorCheck()) {
                            ...
                            h.on("load.infiniteScroll", function(e, i) {
                                ...
                                if (a.find(".woocommerce-result-count").length) {
                                    var l = a.find(".woocommerce-result-count").text(),
                                        f = l.replace(/\d\u2013\d+/, "1\u2013" + (a.find(".wpr-grid-item").length + o.length));
                                    a.find(".woocommerce-result-count").text(f)
                                }
                                ...
                                n(y), h.data("lightGallery").destroy(!0), h.lightGallery(y.lightbox), s(), r(), p(), window.dispatchEvent(new Event("resize"))
                        ...
                        var L = a.find(".wpr-grid-slider-prev-arrow"),
                            E = a.find(".wpr-grid-slider-next-arrow");
                        if (0 < L.length && 0 < E.length) {
                            var B = -2 * L.position().left;
                            0 < B && (t(window).on("load", function() {
                                t(window).width() <= a.outerWidth() + L.outerWidth() + E.outerWidth() + B && (L.addClass("wpr-adjust-slider-prev-arrow"), E.addClass("wpr-adjust-slider-next-arrow"))
                            }), t(window).smartresize(function() {
                                t(window).width() <= a.outerWidth() + L.outerWidth() + E.outerWidth() + B ? (L.addClass("wpr-adjust-slider-prev-arrow"), E.addClass("wpr-adjust-slider-next-arrow")) : (L.removeClass("wpr-adjust-slider-prev-arrow"), E.removeClass("wpr-adjust-slider-next-arrow"))
                            }))
                        }
                    ...
                    if (N.observe(a[0], {
                        ...
                        var V = h.find(".wpr-grid-item-add-to-cart").find("i"),
                            H = V.attr("class");
                        V.length && (H = H.substring(H.indexOf("fa-"), H.length)), t("body").on("adding_to_cart", function(e, t) {
                            t.fadeTo("slow", 0)
                            ...
                            V.length && (s.find("i").removeClass(H).addClass("fa-check"), setTimeout(function() {
                                s.find("i").removeClass("fa-check").addClass(H)
                            }, 3500))
                        })
                    }
            ...
            widgetAdvancedSlider: function(e) {
                ...
                if (n.slick({
                        ...
                        0 !== e.find(".wpr-slider-img").length && (e.find(".wpr-advanced-slider").css("height", e.find(".slick-current").outerHeight()), e.find(".wpr-slider-arrow").on("click", function() {
                            console.log("works resize"), e.find(".wpr-advanced-slider").css("height", e.find(".slick-current").outerHeight())
                        }), t(window).smartresize(function() {
                ...
                function r() {
                    if (i.hasClass("wpr-twitter-feed-carousel")) {
                        ...
                        var a = i.find(".wpr-twitter-feed-cont"),
                            ...
                            p = +elementorFrontend.config.responsive.breakpoints.widescreen.value;
                        e(a, {
                            hashNavigation: !("yes" !== t.wpr_cs_navigation),
            ...
            widgetInstagramFeed: function(i) {
                if (0 < i.find(".wpr-insta-feed-content-wrap").length) {
                    function f(e) {
                    ...
                    function w(a) {
                        if (-1 !== i.find(".wpr-insta-feed-item-lightbox").length) {
                            ...
                            r.each(function() {
                            ...
                            }), h.lightGallery(a.lightbox), h.on("onAfterOpen.lg", function() {
                                t(".lg-outer").find(".lg-thumb-item").length && t(".lg-outer").find(".lg-thumb-item").each(function() {
                                    var e = t(this).find("img").attr("src"),
                                        i = e,
                                        a = e.lastIndexOf("."),
                                ...
                                e.editorCheck() ? alert("Lightbox is Disabled in the Editor!") : t(this).closest(".wpr-insta-feed-content-wrap").find(".wpr-insta-feed-image-wrap").trigger("click")
                            })) : r.find(".inner-block > span").on("click", function() {
                                if (!e.editorCheck()) {
                    ...
                    function m() {
                        "yes" !== h.find(".wpr-insta-feed-media-wrap").attr("data-overlay-link") || e.editorCheck() || (h.find(".wpr-insta-feed-media-wrap").css("cursor", "pointer"), h.find(".wpr-insta-feed-media-wrap").on("click", function(e) {
                            var i = e.target.className;
                            if (-1 !== i.indexOf("inner-block") || -1 !== i.indexOf("wpr-cv-inner") || -1 !== i.indexOf("wpr-insta-feed-media-hover")) {
                                ...
                                var a = t(this).find(".wpr-insta-feed-media-hover-bg").attr("data-url"),
                                    a = a.replace("#new_tab", "");
                                "_blank" === h.find(".wpr-insta-feed-media-hover-bg").data("target") ? window.open(a, "_blank").focus() : window.location.href = a
                            }
                        }))
                    }
                    let h = i.find(".wpr-instagram-feed");
                    if (h.attr("data-settings")) var a = JSON.parse(h.attr("data-settings")),
                        r = a.insta_load_more_settings;
                    var s = i.attr("data-id"),
                        n = r.limit,
                        o = i.find(".wpr-grid-pagination");
                    if (i.hasClass("wpr-insta-feed-layout-full-width") && r.limit > i.find(".wpr-insta-feed-content-wrap").length && i.find(".wpr-layout-full-width").css("grid-template-columns", "repeat(" + i.find(".wpr-insta-feed-content-wrap").length + ", minmax(0, 1fr))"), i.hasClass("wpr-insta-feed-masonry") && (f(a), setTimeout(function() {
                            f(a)
                        }, 100), e.editorCheck() && (setTimeout(function() {
                            f(a)
                        }, 500), setTimeout(function() {
                        ...
                        i.find(".wpr-insta-feed-item-below-content").css({
                            float: d,
                            width: "calc((100% - " + l + "%) - " + p + "px)"
                        }), t(window).smartresize(function() {
                            d = a.media_align, l = a.media_width, p = a.media_distance, i.find(".wpr-insta-feed-item-below-content").css({
                                float: d,
                                width: "calc((100% - " + l + "%) - " + p + "px)"
                            })
                        })
                    ...
                    e.editorCheck() || i.find(".wpr-load-more-insta-posts").on("click", function() {
                            o.find(".wpr-load-more-btn").hide(), o.find(".wpr-pagination-loading").css("display", "inline-block"), t.ajax({
                                type: "POST",
                                url: WprConfig.ajaxurl,
                                data: {
                                    action: "wpr_load_more_instagram_posts",
                                    nonce: WprConfig.nonce,
                                    wpr_load_more_settings: r,
                                    wpr_insta_feed_widget_id: s,
                                    next_post_index: n
                                },
                                success: function(e) {
                                    var s = t(e);
                                    ...
                                    }), i.find(".wpr-instagram-feed").append(s), i.hasClass("wpr-insta-feed-layout-list") && (d = a.media_align, l = a.media_width, p = a.media_distance, i.find(".wpr-insta-feed-item-below-content").css({
                                        float: d,
                                        width: "calc((100% - " + l + "%) - " + p + "px)"
                                    })), i.hasClass("wpr-insta-feed-masonry") && (h.isotopewpr("appended", s), h.isotopewpr("reloadItems"), h.isotopewpr("layout"), t(window).trigger("resize")), setTimeout(function() {
                                        s.each(function() {
                                            var e = t(this);
                                            setTimeout(function() {
                                                e.removeClass("wpr-instagram-hidden-item")
                                            }, 100)
                                        }), o.find(".wpr-pagination-loading").hide(), e.includes("wpr-insta-feed-content-wrap") ? setTimeout(function() {
                                            o.find(".wpr-load-more-btn").fadeIn()
                                        }, 400) : (o.find(".wpr-pagination-finish").fadeIn(1e3), o.delay(2e3).fadeOut(1e3), setTimeout(function() {
                                            o.find(".wpr-pagination-loading").hide()
                                        }, 500))
                                    }, 400), n += r.limit, h.data("lightGallery") && h.data("lightGallery").destroy(!0), m()
                                },
                                error: function(e) {
                                    console.log(e)
                                }
                            ...
                            if (i.hasClass("wpr-insta-feed-layout-carousel")) {
                                ...
                                var r = i.find(".wpr-instagram-feed-cont"),
                                    s = +elementorFrontend.config.responsive.breakpoints.mobile.value + 1,
                                    n = +elementorFrontend.config.responsive.breakpoints.mobile_extra.value + 1,
                                    o = +elementorFrontend.config.responsive.breakpoints.tablet.value + 1,
                                    d = +elementorFrontend.config.responsive.breakpoints.tablet_extra.value + 1,
                                    l = +elementorFrontend.config.responsive.breakpoints.laptop.value + 1,
                            ...
                            h.length && h.css("opacity", 1)
                        }), e.editorCheck() && h.length && h.css("opacity", 1), m(), w(a),
                        function() {
            ...
            widgetProductAddToCart: function(e) {
                var i = jQuery(".woocommerce .wpr-quantity-wrapper"),
                    a = i.find("input.qty").attr("max") ? i.find("input.qty").attr("max") : 99999999,
                    r = e.find(".wpr-product-add-to-cart").attr("layout-settings"),
                    s = e.find(".wpr-add-to-cart-icons-wrap"),
                    n = e.find(".wpr-add-to-cart-icons-wrap").length ? "first-child" : "last-child",
                    o = e.find(".wpr-add-to-cart-icons-wrap").length ? "last-child" : "first-child";
                e.find("input.qty").each(function() {
                    t(this).val() || t(this).val(0)
                }), e.find(".variations").find("select").on("change", function() {
                    var i = !1;
                    e.find(".variations").find("select").each(function() {
                        "choose an option" !== t(this).find("option:selected").text().toLowerCase() && (i = !0)
                    }), !1 == i ? e.find(".reset_variations").css("display", "none") : e.find(".reset_variations").css("display", "inline-block")
                }), "default" !== r && i.find("input.qty").attr("type", "text").removeAttr("step").removeAttr("min").removeAttr("max"), i.on("click", "i:" + n, function() {
                    parseInt(jQuery(this).prev(".quantity").find("input.qty").val(), 10) < a && "both" == r ? (jQuery(this).prev(".quantity").find("input.qty").val(parseInt(jQuery(this).prev(".quantity").find("input.qty").val(), 10) + 1), jQuery("input[name=\"update_cart\"]").removeAttr("disabled")) : parseInt(jQuery(this).parent().siblings(".quantity").find("input.qty").val(), 10) < a && "both" !== r && "default" !== r && (jQuery(this).parent().siblings(".quantity").find("input.qty").val(parseInt(jQuery(this).parent().siblings(".quantity").find("input.qty").val(), 10) + 1), jQuery("input[name=\"update_cart\"]").removeAttr("disabled"))
                }), i.on("click", "i:" + o, function() {
                    0 < parseInt(jQuery(this).next(".quantity").find("input.qty").val(), 10) && "both" == r ? (jQuery(this).next(".quantity").find("input.qty").val(parseInt(jQuery(this).next(".quantity").find("input.qty").val(), 10) - 1), jQuery("input[name=\"update_cart\"]").removeAttr("disabled")) : 0 < parseInt(jQuery(this).parent().siblings(".quantity").find("input.qty").val(), 10) && "both" !== r && "default" !== r && (jQuery(this).parent().siblings(".quantity").find("input.qty").val(parseInt(jQuery(this).parent().siblings(".quantity").find("input.qty").val(), 10) - 1), jQuery("input[name=\"update_cart\"]").removeAttr("disabled"))
                }), i.find("input.qty").keyup(function() {
                    jQuery(this).val() > a && jQuery(this).val(a)
                }), "yes" !== e.find(".wpr-product-add-to-cart").data("ajax-add-to-cart") || t("div[data-elementor-type=\"wpr-theme-builder\"]").hasClass("product-type-external") || e.find(".single_add_to_cart_button").on("click", function(i) {
                    i.preventDefault();
                    let a = t(this).closest("form");
                    var r = a.closest(".variations_form");
                    let s = a.hasClass("grouped_form");
                    ...
                    if (s) {
                        let i = !1;
                        if (e.find(".woocommerce-grouped-product-list-item__quantity").find("input").each(function() {
                                0 < t(this).val() && (i = !0)
                            }), !i) return void alert(WprConfig.chooseQuantityText)
                    }
                    t.ajax({
                        type: "POST",
                        url: WprConfig.ajaxurl,
                        ...
                        success: function(i) {
                            return i.notices && 0 < i.notices.length && ("wc_low_stock" === i.notices[0].type ? alert("Only " + i.notices[0].message + " left in stock!") : alert(i.notices[0].message)), i.error && i.product_url ? void(window.location = i.product_url) : "undefined" != typeof wc_add_to_cart_params && void(0 < r.length && !r.find(".variations select").val() || n.hasClass("disabled") || (t(document.body).trigger("wc_fragment_refresh"), t(document.body).trigger("added_to_cart", [i.fragments, i.cart_hash, n]), setTimeout(function() {
                                n.removeClass("added");
                                var i = parseInt(t(".wpr-mini-cart-icon-count").text()),
                                    a = parseInt(e.find(".wpr-quantity-wrapper .qty").val());
                                t(".wpr-mini-cart-icon-count").text(i + a)
                            }, 1e3)))
                        }
                    })
                })
            ...
            widgetProductMiniCart: function(i) {
                ...
                t("body").on("click", function(t) {
                    t.target.classList.value.includes("wpr-mini-cart") || t.target.closest(".wpr-mini-cart") || (i.hasClass("wpr-mini-cart-slide") ? i.find(".wpr-mini-cart").slideUp(r) : i.find(".wpr-mini-cart").fadeOut(r))
                    ...
                    a.stopPropagation(), a.preventDefault(), "none" === i.find(".wpr-mini-cart").css("display") ? (i.hasClass("wpr-mini-cart-slide") ? i.find(".wpr-mini-cart").slideDown(r) : i.find(".wpr-mini-cart").fadeIn(r), i.hasClass("wpr-mini-cart-sidebar") && (i.find(".wpr-shopping-cart-wrap").fadeIn(r), i.find(".wpr-shopping-cart-inner-wrap").addClass("wpr-mini-cart-slide-in"), i.find(".wpr-mini-cart-slide-in").css("animation-speed", r), t("body").addClass("wpr-mini-cart-sidebar-body")), setTimeout(function() {
                    ...
                    }, r + 100)) : i.hasClass("wpr-mini-cart-slide") ? i.find(".wpr-mini-cart").slideUp(r) : i.find(".wpr-mini-cart").fadeOut(r)
                });
